 ...
 * */
     ...
     * 1111111111
     */
    public static ByteArrayOutputStream encode(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
//    public static String encode(String content, String imgPath, String destPath, boolean needCompress) throws Exception {
//        1.调用createImage方法创建二维码
...
//        return file;
    ...
    public static void main(String[] args) throws Exception {
        String text = "fafrgr";  //这里设置自定义网站url
...
//        System.out.println(QRCodeUtils.encode(text, logoPath, destPath, true));
        ByteArrayOutputStream encodeIO = QRCodeUtils.encode(text,"", "", true);
        //输入数组
